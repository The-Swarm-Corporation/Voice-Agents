...
1. **`example_format_text_for_speech.py`**
...
7. **`example_streaming_tts_callback.py`**
   - StreamingTTSCallback class usage
   - Real-time text-to-speech conversion
   - Integration with agent frameworks

8. **`example_get_media_type.py`**
   - Media type (MIME type) utilities
   - FastAPI integration examples
   - Format validation helpers

9. **`example_voice_selection.py`**
...
10. **`example_complete_voice_agent.py`**
...
### Text-to-Speech (TTS)
- `example_stream_tts.py` - OpenAI TTS
- `example_stream_tts_elevenlabs.py` - ElevenLabs TTS
- `example_streaming_tts_callback.py` - Streaming callbacks

### Speech-to-Text (STT)
- `example_speech_to_text.py` - Whisper transcription
- `example_record_audio.py` - Audio recording

### Utilities
- `example_format_text_for_speech.py` - Text formatting
- `example_play_audio.py` - Audio playback
- `example_get_media_type.py` - Media type helpers
- `example_voice_selection.py` - Voice selection

### Complete Workflows
- `example_complete_voice_agent.py` - Full agent examples
