...
models = list_models()
elevenlabs_models = [
    m for m in models if m["provider"] == "elevenlabs"
]
...
voices = list_voices()
elevenlabs_voices = [
    v for v in voices if v["provider"] == "elevenlabs"
]
...
stream_tts(
    [text1], model="elevenlabs/eleven_multilingual_v2", voice="rachel"
)
...
print(
    "Example 2: Trying different ElevenLabs voices with unified stream_tts"
)
...
stream_tts(
    chunks, model="elevenlabs/eleven_multilingual_v2", voice="rachel"
)
print("Playback complete!\n")
...
text4 = (
    "This voice has custom stability and similarity boost settings."
)
...
stream_tts_elevenlabs(
    [text4], voice_id="rachel", stability=0.8, similarity_boost=0.9
)
...
print(
    "MP3 and Opus formats require return_generator=True for API use."
)
print("Playing with PCM 44100 format...")
stream_tts_elevenlabs(
    [text6], voice_id="rachel", output_format="pcm_44100"
)
...
elevenlabs_voices = [
    v for v in list_voices() if v["provider"] == "elevenlabs"
]
